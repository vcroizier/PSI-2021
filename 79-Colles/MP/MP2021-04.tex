...
n\degres4 -- le vendredi 08/10/2021}{3}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{eleve}{}
...
\begin{eleveF}{}
  ...
  \exo3
  Soit $u\in\R^{\N}$ tel que $\lim_{n\to+\infty}\frac{u_{2n+1}}{u_{2n}}=a\in\R$ 
  et $\lim_{n\to+\infty}\frac{u_{2n+2}}{u_{2n+1}}=b\in\R$.
  
  Discuter la nature de $\sum_{n\geq0}u_n$ en fonction de $a$ et $b$.
