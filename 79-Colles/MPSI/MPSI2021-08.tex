...
\begin{eleve}{}
  ...
  Calculer $A=\arctan(\tfrac12)+\arctan(\tfrac13)$.
  ...
  Démo de la dérivabilité de $\arcsin$, dérivée.
  
  Calculer $I=\int_0^1\frac{1}{1+x^2}dx$.
  ...
  \cours
  Tout sur $\arctan$ + démo dérivabilité.
  
  Calculer $I=\int_0^{\tfrac{\sqrt3}{2}}\frac{1}{\sqrt{1-x^2}}dx$.
