...
\begin{document}
\Titre{PSI}{Promotion 2021--2022}{Mathématiques}{Devoir non surveillé n\degres2}
...
Ainsi,
\fbox{$f$ est prolongeable par continuité en $0$ en posant $f(0)=1$}
...
Ainsi,
\fbox{$f$ est dérivable en $0$ et $f'(0)= - \dfrac{1}{2}$}
...
\fbox{$f$ est de classe $C^{1}$ sur $\mathcal{D}^{\prime}$}
...
\end{align*}
Ainsi,
\fbox{La valeur approchée est obtenue pour $N=99$}
...
\end{itemize}
Ainsi, 
\fbox{pour tout entier $n \geq 1$, les coefficients de $T_{n}$ sont des entiers}
