...
\end{ptc}
%
%\begin{Exercice}{}\end{Exercice} Faire une fiche concernant les fonctions cos, sin, tan, arcsin, arcos et arctan résumant les résultats suivants : ensemble de définition, ensemble de dérivabilité et dérivée, valeurs particulières, courbes représentatives, formules de trigonométrie usuelles ($\cos(a+b)$, $\cos(p)\cos(q)$ $\ldots$).
...
%\medskip
%
%\begin{Exercice}{}\end{Exercice} A l'aide du théorème de bijection monotone et du théorème de dérivabilité d'une bijection réciproque, démontrer que la fonction $\cos$ est bijective de $[0,\pi]$ sur $[-1,1]$, que sa bijection réciproque (arcos) est dérivable sur $]-1,1[$ et que pour tout $x \in ]-1,1[$,
...
\end{ptc}
%
%\begin{Exercice}{}\end{Exercice} Faire une fiche résumant les résultats suivants : développements limités usuels en $0$, équivalents usuels en $0$.
%
%\medskip
...
%\begin{Exercice}{}\end{Exercice} Effectuer la division euclidienne de $X^5-X^4-2X^2-3X+1$ par $X^2+2$.
...
\end{ptc}
%
%\begin{Exercice}{}\end{Exercice} Soit $f \in \mathcal{L}(E,F)$. Redonner la définition du noyau et de l'image de $f$. Montrer que ce sont des sous-espaces vectoriels (de $E$ pour le noyau, de $F$ pour l'image).
...
%\medskip
%
%\begin{Exercice}{}\end{Exercice} Soient $q$ et $q$ deux projecteurs d'un espace vectoriel $E$. Montrer que $p$ et $q$ ont le même noyau si et seulement si $p=p \circ q$ et $q=q \circ p$.
...
%
%%
%%\begin{Exercice}{}\end{Exercice} Pour tout entier $n$ supérieur ou égal à $3$, on pose pour tout $x \in [0,1]$, $f_n(x)=x^n+1-nx.$
%%\begin{enumerate}
...
%%\medskip
%%
%%\begin{Exercice}{}\end{Exercice} Soient $n$ un entier naturel non nul et $E$ un $\mathbb{R}$-espace vectoriel de dimension $n$. On dit qu'un endomorphisme $f$ de $E$ est cyclique si il existe un vecteur $x$ de $E$ tel que $(x,f(x),f^2(x), \ldots, f^n(x))$ soit une base de $E$.
%%
%%\medskip
%%
%%\begin{enumerate}
