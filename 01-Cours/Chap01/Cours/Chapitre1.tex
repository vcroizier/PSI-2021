...
\begin{multicols}{2}
\begin{itemize}
\item $\lim_{x \rightarrow +\infty} \frac{e^{\alpha x}}{x^{\beta}}= + \infty$
\item $\lim_{x \rightarrow +\infty} \frac{e^{\alpha x}}{\ln(x)^{\beta}}= + \infty$
...
\columnbreak
\item $\lim_{x \rightarrow +\infty} \frac{x^{\alpha}}{\ln(x)^{\beta}}= + \infty$
