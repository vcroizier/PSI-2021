...
%\begin{Exa} Considérons l'arc paramétré du plan défini par :
...
\begin{Exa} Étudier l'arc paramétré défini par :
...
\begin{Exa} On considère l'arc paramétré plan défini pour tout $t \in [0,2\pi]$ par :
