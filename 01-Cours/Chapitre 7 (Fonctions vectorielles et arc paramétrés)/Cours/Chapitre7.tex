...
Dans tout le chapitre, $I$ est un intervalle de $\mathbb{R}$ contenant au moins deux points et $n$ et $m$ sont deux entiers naturels non nul. Sauf indication contraire, $f$ désignera une application définie sur $I$ et à valeurs dans $\mathbb{R}^n$.
...
%\medskip
%
%\begin{Proposition}{continuité composante par composante} Soit $a \in I$. La fonction $f$ est continue en $a$ si et seulement si pour tout $k \in \Interv{1}{n}$, $f_k$ est continue en $a$. 
%\end{Proposition}
%
...
%\begin{Proposition}{dérivation composante par composante} Soit $a \in I$. La fonction $f$ est dérivable en $a$ si et seulement si pour tout $k \in \Interv{1}{n}$, $f_k$ est dérivable en $a$. Dans ce cas, on a :
%$$ f'(a) = (f_1^{'}(a), f_2^{'}(a) ,\ldots, f_n^{'}(a))$$
%\end{Proposition}
