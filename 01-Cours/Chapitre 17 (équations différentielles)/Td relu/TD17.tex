...
%\medskip
%
%\noindent \textit{Synthèse.} Soit $y$ une solution de la forme précédente.
%
%\begin{itemize}
...
%$$\mathcal{S}_{\mathbb{R}} = \textrm{Vect}_{\mathbb{R}} (f_1,f_2,f_3)$$
...
%$$\mathcal{S}_{\mathbb{C}} = \textrm{Vect}_{\mathbb{C}} (f_1,f_2,f_3)$$
...
%$$ \mathcal{S}_{\mathbb{R}} = \textrm{Vect}(f_1,g_2,g_3)$$
%
