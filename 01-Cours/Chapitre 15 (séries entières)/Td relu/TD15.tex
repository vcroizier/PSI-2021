...
\begin{Exercice}{\ding{80}} Le but de cet exercice est de justifier l'existence et calculer la valeur de la somme :  
\[
...
\begin{Exercice}{\ding{80}} Soit $\Sum{n \geq 0}{} a_n z^n$ une série entière de rayon de convergence $R>0$. Montrer que  la série $\Sum{n \geq 0}{} \dfrac{a_n}{n!}z^n$ a un rayon de convergence infini. 
\end{Exercice}
...
\begin{Exercice}{\ding{80}} Déterminer le rayon de convergence $R$ de $\dis \sum_{n \geq 0} x^{n^2}$. Déterminer un équivalent simple en $R^{-}$ de la somme de cette série entière.
\end{Exercice}
...
\begin{Exercice}{\ding{80}} Soit $(a_n)_{n \geq 0}$ une suite de réels telle que $na_n$ tend vers $0$ quand $n$ tend vers $+ \infty$.
\begin{enumerate}
...
\begin{Exercice}{\ding{80}} Soit $(u_n)_{n \geq 0}$ la suite définie par $u_0=0$ et pour tout $n \geq 0$ par 
