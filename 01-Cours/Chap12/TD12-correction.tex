...
\begin{document}
\Titre{PSI}{Promotion 2021--2022}{Mathématiques}{Correction du TD 12 : Espaces vectoriels normés}
...
%%$$\forall A\in {\cal M}_n(\R),\qquad N_1(A)=\sup_{X\in{\cal  M}_{n,1}(\R)\setminus\{0\}}\frac{\|AX\|}{\|X\|},\quad N_2(A)=\sup_{\|X\|\leq 1}\|AX\| \quad\hbox{et}\quad N_3(A)=\sup_{\|X\|= 1}\|AX\|.$$
%%
%%\begin{enumerate}
