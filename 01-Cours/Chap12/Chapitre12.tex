...
%Une somme de termes positifs est nulle si et seulement si tous les termes sont nuls donc pour tout $i \in \iii{1}{n}$, $\vert x_i \vert = 0$ et donc $x_i=0$. Ainsi $x=0_{\mathbb{K}^n}$.
...
%\medskip
%
%$\rhd$ Montrons uniquement l'inégalité triangulaire pour la norme infini (les autres propriétés étant simples à montrer) : soit $(x,y) \in (\mathbb{K}^n)^2$. On a pour tout $i \in \iii{1}{n}$, d'après l'inégalité triangulaire,
...
%%Or, pour tout $i \in \iii{1}{p}$ et tout $n \geq 0$,
...
%\medskip
%
%$\rhd$ Supposons que pour tout $i \in \iii{1}{p}$, la suite $(u_{n,i})_{n \geq 0}$ converge vers un scalaire $\ell_i$.
%
%% Considérons la norme $1$ (légitime car $E$ est de dimension finie). On a pour tout $i \in \iii{1}{p}$,
