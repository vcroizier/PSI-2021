...
%& = \left[ \frac{x}{1+x^2} \right]_a^b + 2 \int_{a}^b \frac{1}{1+x^2} \dx - 2\frac{1}{(1+x^2)^2} \dx \\
%\end{align*}
%Finalement, en isolant l'intégrale cherchée, on obtient :
%$$ \int_{a}^b \frac{1}{(1+x^2)^2} \dx = \frac{1}{3} \int_{a}^b \frac{1}{1+x^2} + \frac{1}{2}\left[ \frac{x}{1+x^2} \right]_a^b $$
