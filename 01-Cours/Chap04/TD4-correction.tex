...
\begin{document}
\Titre{PSI}{Promotion 2021--2022}{Mathématiques}{Correction du TD 4 : Applications linéaires}

\tableofcontents
\separationTitre

\subsection{Noyaux, images}
...
$$ \textrm{Im}(f) = \textrm{Vect}((1,1,1),(0,0,1))$$
...
\item Il est clair que pour tout $M \in \mathcal{M}_2(\mathbb{R})$, $f(M) \in \mathcal{M}_2(\mathbb{R})$. Pour tout $(M,N) \in \mathcal{M}_2(\mathbb{R})^2$ et tout réel $\lambda$,
...
\subsection{Projections, symétries}
...
%$$ P_i(X) = \prod_{k \in \iii{1}{n} \setminus \lbrace i \rbrace} \dfrac{X-x_k}{x_i-x_k}$$
%où pour tout $k \in \iii{1}{n}$,
%$$ L_k(X) = \prod_{r \in \iii{1}{n} \setminus \lbrace k \rbrace} \dfrac{X-x_r}{x_k- x_r}$$
%Le polynôme $P$ est une somme de polynômes de degré $n-1$ donc est bien de degré au plus $n-1$ et vérifie pour tout $j \in \iii{1}{n}$ que $P_i(x_j)= a_i$ car (de manière usuelle) $L_i(x_k) = \delta_{i,k}$.
...
%\exo Soient $n \in \mathbb{N}^*$ et $(e_1, \ldots, e_n)$ une base d'un $\mathbb{K}$-espace vectoriel $E$. Posons pour tout $i \in \iii{1}{n}$,
