...
\Titre{PSI}{Promotion 2021--2022}{Mathématiques}{Chapitre 4 : Applications linéaires}
...
%
%\vspace{7cm}
%%$\rhd$ \emph{Analyse} : soit $f \in \mathcal{L}(E,F)$ tel que pour tout $i \in \iii{1}{n}$, $f(e_i)=f_i$. Tout vecteur $x \in E$ s'écrit sous la forme :
...
%%On montre facilement que $f$ est une application linéaire de $E$ dans $F$ et que pour tout $i \in \iii{1}{n}$, $f(e_i)=f_i$. L'unicité d'une telle application est prouvée dans l'analyse.
%\end{Demonstration}
...
%%Or la famille $(e_1,e_2, \ldots, e_n)$ est une base donc libre et ainsi pour tout $k \in \iii{1}{n}$, $\lambda_k=0$. La famille $(f(e_1), f(e_2), \ldots, f(e_n))$ est donc une famille libre.
%%
%%\medskip
%%
...
%%Par liberté de la famille $(f(e_1), f(e_2), \ldots, f(e_n))$, on a pour tout $k \in \iii{1}{n}$, $x_k=0$ et ainsi $x=0_E$. On vient donc de montrer que $\textrm{Ker}(f) \subset \lbrace 0_E \rbrace$ et l'autre inclusion est vraie. 
