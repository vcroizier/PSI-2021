...
%
%$\rhd$ Supposons que $u$ est diagonalisable. Notons $\lambda_1$, $\ldots$, $\lambda_k$ ($k \geq 1$) les valeurs propres de $u$. On sait d'après la preuve du théorème précédent que :
