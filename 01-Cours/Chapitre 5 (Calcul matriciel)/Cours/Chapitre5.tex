...
%\medskip
%
%$\rhd$ \emph{Première méthode} : soit $n \geq 2$. En effectuant pour tout $k \in \Interv{2}{n}$ les opérations élémentaires $L_k \leftarrow L_k-L_1$, on a :
%$$ V_n(a_1, \ldots, a_n) = \left\vert \begin{array}{ccccc}
%1 & a_1 & a_1^2  & \ldots & a_1^{n-1} \\
...
%\end{array}\right\vert  $$
%On effectue ensuite \emph{successivement}, pour tout $k \in \Interv{2}{n-1}$, les opérations $C_k \leftarrow \Sum{i=1}{k-1} a_1^i C_i$ :
%$$ V_n(a_1, \ldots, a_n)  =  \prod_{2 \leq k \leq n} (a_k - a_1) \, \, \left\vert\begin{array}{cccc}
% 1 & a_2& \ldots & a_2^{n-2}\\
% 1& a_3 & \ldots & a_3^{n-2}  \\
% \vdots &  \vdots & & \vdots \\
