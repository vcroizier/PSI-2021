...
\maketitle{Chapitre 6}{Suites et séries de fonctions}

%\maketitle{Chapitre 7}{Suites et séries de fonctions}
...
%$$ \dis \lim_{n \rightarrow + \infty} f_n(x) = 0$$
%car $x \in ]-1,1[$.
...
%\noindent Soit $x \in \mathbb{R}$. On a :
...
\newpage
$\phantom{test}$
%\noindent Distinguons plusieurs cas :
%
%\begin{itemize}
...
%\medskip
%
%\noindent Ainsi $f_n \xrightarrow[n \rightarrow + \infty]{\textrm{CVS}} f$ où $f : \mathbb{R}_+ \rightarrow \mathbb{R}$ est définie par :
%
%$$ f(x) = \left\lbrace \begin{array}{ccl}
...
%\item $\dis \sup_{x \in I} \vert f_n(x) - f(x) \vert \underset{n \rightarrow + \infty}{\rightarrow} 0$.
%\end{itemize}
%\end{defin}
...
%
%\begin{metho} On commence généralement par étudier la convergence simple de la suite de fonctions pour déterminer la fonction qui est potentiellement la limite uniforme.
%\end{metho}
%
%\begin{ex} Considérons la suite de fonctions de l'introduction : pour tout $n \geq 0$, on considère la fonction $f_n$ définie pour tout $x \in I= [-1,1]$ par $f_n(x)=x^n$. On sait que $(f_n)_{n \geq 0}$ converge simplement sur $]-1,1]$ vers la fonction $f$ définie par :
%$$ f(x) = \left\lbrace \begin{array}{ccl}
%0 & \hbox{ si } x \in ]-1,1] \\
%1 & \hbox{ si } x =1 \\
%\end{array}\right. $$
...
%
%
%\begin{prop} Soit $(f_n)_{n \geq 0}$ une suite de fonctions définies sur $I$ à valeurs dans $\mathbb{K}$. La suite $(f_n)_{n \geq 0}$ \textit{converge uniformément} vers une fonction $f : I \rightarrow \mathbb{K}$ si et seulement si il existe une suite réelle $(a_n)_{n \geq 0}$ telles que les deux conditions suivantes soient vérifiées :
%
%\begin{itemize}
%\item A partir d'un certain rang, $\sup_{x \in I} \vert f_n(x)-f(x) \vert \leq a_n$.
%\item $\dis \lim_{n \rightarrow + \infty} a_n = 0$.
%\end{itemize}
%\end{prop} 
%
%\begin{rem} $\sup_{x \in I} \vert f_n(x)-f(x) \vert = \Vert f_n -f \Vert_{ \infty}$.
%\end{rem}
%
...
%\medskip
%
%\noindent $\rhd$ Supposons que $(f_n)_{n \geq 0}$ converge uniformément vers $f$. A partir d'un certain rang $N$, les fonctions $f_n-f$ sont bornées et on pose dans ce cas :
%$$ a_n = \sup_{x \in I} \vert f_n(x)-f(x) \vert$$
%On pose $a_n=0$ pour tout $n \in \Interv{0}{N}$. Par définition de la convergence uniforme, on a alors bien :
%$$ \lim_{n \rightarrow + \infty} a_n = 0$$
%
%\medskip
%
%\noindent $\rhd$ Supposons l'existence d'une une suite réelle $(a_n)_{n \geq 0}$, convergeant vers $0
...
\begin{ex} On pose pour tout $n \geq 0$ et tout $x \in \mathbb{R}_+$, $f_n(x)= nx^2 e^{-nx}$. Étudions la convergence uniforme de $(f_n)_{n \geq 0}$ sur $\mathbb{R}_+$. 

\medskip

\noindent $\rhd$ Commençons par étudier la convergence simple sur $\mathbb{R}_+$.
...
\noindent $\rhd$ Étudions la convergence uniforme sur $\mathbb{R}_+$.
...
\begin{rem} Si $(f_n)_{n \geq 0}$ converge uniformément vers une fonction $f$ sur un intervalle $I$ alors pour tout suite $(x_n)_{n \geq 0}$ d'éléments de $I$, on a :
...
%\medskip
%
%\noindent $\rhd$ Soit $x \in \mathbb{R}_+$. La suite $\left( \frac{1}{x+n} \right)_{n \geq 0}$ est décroissante et converge vers $0$ donc d'après le critère spécial des séries alternées, la série $\dis \sum_{n \geq 1} f_n(x)$ converge.
%
%\noindent Ainsi, la série $\dis \sum_{n \geq 1} f_n$ converge simplement sur $\mathbb{R}_+$.
%
%\medskip
%
%\noindent $\rhd$ Posons pour tout $x \in \mathbb{R}_+$ et tout $n \geq 1$, 
...
%\medskip
%
%\noindent $\rhd$ Finalement, $\dis \sum_{n \geq 1} f_n$ converge uniformément sur $\mathbb{R}_+$.
...
\item \phantom{La série numérique $\dis \sum_{n \geq 0} \Vert f_n \Vert_{\infty}$ converge.}
\end{itemize}
\end{defin}
...
%Par hypothèse la série de fonctions $\dis \sum_{n \geq 0} \Vert f_n \Vert_{\infty}$ converge donc par comparaison de séries à termes positifs, la série de terme général $\vert f_n(x) \vert$ converge absolument et donc converge. Ainsi, pour tout $x \in I$,
%$$ \sum_{n \geq 0} f_n(x)$$
%converge et donc la série $\sum_{n \geq 0} f_n$ converge simplement sur $I$.
%
%\medskip
%
%\noindent Montrons maintenant la convergence uniforme de $\sum_{n \geq 0} f_n$ sur $I$. D'après la proposition (\ref{CritCVU}), il suffit de montrer que la suite des restes de cette série converge uniformément vers $0$ sur $I$. On sait que pour tout $x \in I$ et tout $n \in \mathbb{N}$,
%$$ R_n(x) = \sum_{k=n+1}^{+ \infty} f_k(x) $$
...
%\end{equation}
%Or $\dis \sum_{n \geq 0} f_n$ converge normalement par définition $\dis \sum_{n \geq 0} \Vert f_n \Vert_{\infty}$ converge et ses restes tendent vers $0$ :
...
\begin{metho} Pour étudier la convergence normale d'une série de fonctions, on peut procéder de la manière suivante : on détermine une suite $(\alpha_n)_{n\geq 0}$ (qui ne \textit{dépend pas} de $x$) tel que pour tout $n \geq 0$,
...
\medskip
%
%\noindent Pour pour tout $n \geq 0$ et tout $x \in \mathbb{R}$, on a :
...
%est convergente. D'après (\ref{ineg2}), on obtient que la série $\dis \sum_{n \geq 0} f_n$ converge normalement sur $\mathbb{R}$ et donc uniformément sur $\mathbb{R}$.
...
\begin{defin} Soit $(f_n)_{n \geq 0}$ une suite de fonctions définies sur $I$ à valeurs dans $\mathbb{K}$. On dit que $(f_n)_{n \geq 0}$ \textit{converge uniformément} sur tout segment de $I$ vers une fonction $f : I \rightarrow \mathbb{K}$ si pour tout segment $[a,b] \subset I$, $(f_n)_{n \geq 0}$ converge uniformément vers $f$ sur $[a,b]$.
\end{defin} 
...
\medskip
%
%\noindent $\rhd$ La fonction $\zeta$ est bien définie car pour tout $x>1$, la série de terme général $\frac{1}{n^x}$ converge (série de Riemann).
%
%\medskip
%
%\noindent $\rhd$ Montrons que $\zeta$ est continue sur $]1, + \infty[$. Posons pour tout $n \geq 1$,
%$$ f_n : x \mapsto \frac{1}{n^x}$$
%
%\noindent Soit $[a,b] \subset ]1, + \infty[$. Pour tout $x \in [a,b]$ et tout $n \geq 1$,
...
\begin{thm}[Interversion limite/somme]
\noindent Soient $(f_n)_{n \geq 0}$ une suite de fonctions définies sur $I$ à valeurs dans $\mathbb{K}$ et $a$ un élément de $I$ ou une extrémité de $I$ (éventuellement infini). On suppose que :
...
%\medskip
%
%\noindent La série $\dis \sum_{n \geq 1} f_n$ où $f_n : x \mapsto \frac{1}{n^x}$ converge normalement sur $[a , + \infty[$ (pour tout $a>1$) : il suffit d'adapter un exemple précédent. En particulier, cette série converge normalement sur $[a, + \infty[$. De plus, pour tout $n \geq 2$ et tout $x \geq a$,
...
%\end{itemize}
%Ainsi, pour tout $x \in [0,1]$, $\dis \lim_{n \rightarrow + \infty} \left( 1 + \frac{x}{n}\right)^n  =  e^x$ donc $(f_n)_{n \geq 1}$ converge simplement vers la fonction exponentielle sur $[0,1]$.
%
%\medskip
%
...
%Et on sait que $\dis \lim_{n\rightarrow + \infty}  \left(1 + \frac{1}{n} \right)^n - e$ (convergence simple en $1$). Ainsi, $(f_n)_{n \geq 1}$ converge uniformément vers la fonction exponentielle sur $[0,1]$.
%
%\medskip
%
%\noindent $\rhd$ La suite $(f_n)_{n \geq 1}$ converge uniformément vers la fonction exponentielle sur $[0,1]$ et toutes les fonctions $f_n$ sont continues sur $[0,1]$ donc d'après le théorème d'interversion limite/intégrale, on a :
%
%\begin{align*}
...
\begin{thm}[Interversion somme/intégrale]  Soit $\dis \sum_{n \geq 0} f_n$ une série de fonctions définies sur $[a,b]$ et à valeurs dans $\mathbb{K}$. Supposons que :
...
\noindent La convergence uniforme d'une suite de fonctions ne suffit pas pour conserver la propriété de dérivabilité : voir l'exemple \ref{PremierEx}.
...
\item La suite $(f_n)_{n \geq 0}$ \textit{converge simplement} vers une fonction $f$ sur $I$.
\item La suite $(f_n')_{n \geq 0}$ \textit{converge uniformément} vers une fonction $g$ sur $I$ (ou sur tout segment de $I$).
\end{enumerate}
...
\begin{thm}[Dérivation terme à terme de séries de fonctions]
...
%\item Si $x \neq 0$, pour tout $n \in \mathbb{N}$, $x_n = \dis \left\vert \frac{x^n}{n!} \right\vert >0$ et l'on a :
%$$ \frac{x_{n+1}}{x_n} = \frac{x}{n+1} \underset{n \rightarrow + \infty}{ \rightarrow} 0$$
%D'après la règle de D'alembert, la série $\dis \sum_{n \geq 0} \dfrac{x^n}{n!}$ est absolument convergente donc convergente.
%\end{itemize}
%Ainsi, la série $\dis \sum_{n \geq 0}f_n$ converge simplement sur $\mathbb{R}$. Notons $f$ la somme de cette série :
...
%
%\noindent La série $\dis \sum_{n \geq 1} \frac{a^{n-1}}{(n-1)!}$ est convergente (décalage d'indice par rapport à la série de terme général $f_n$) et ainsi la série $\dis \sum_{n \geq 1} f_n'$ converge normalement sur tout segment de la forme $[-a,a]$ où $a>0$ et donc sur tout segment de $\mathbb{R}$\footnote{Tout segment est inclus dans un segment symétrique!} et en particulier cette série converge uniformément sur tout segment de $\mathbb{R}$. 
%
%\medskip
%
%\noindent D'après le théorème de dérivation terme à terme des séries de fonctions, la fonction $f$ est donc dérivable et l'on a :
